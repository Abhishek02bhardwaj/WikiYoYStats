...
# Fetch data for both years and both editor types
...
if percentage_change is not None:
    print(f"Percentage change in the number of new pages created Year over Year ({year_1} and {year_2}): {percentage_change:.2f}%")
else:
