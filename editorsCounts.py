...
# Calculate the percentage change
percentage_change = calculate_percentage_change(project, start_date, end_date)

if percentage_change is not None:
    print(f"Percentage change in the number of editors with more than 5 edits: {percentage_change:.2f}%")
else:
